...
namespace Dcupon.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            model.listofstatics = model.Loadstaticlist();
            return View(model);
        ...
        //[HttpPost]
        //public ActionResult emailexistancecheck(string emailid) {
        //    CustomerDetails customerdetails = new CustomerDetails();
        //    bool existance = customerdetails.CheckDuplicates(emailid);
        //    return Json(existance, JsonRequestBehavior.AllowGet);
        //}
