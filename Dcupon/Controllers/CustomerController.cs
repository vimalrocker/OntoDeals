...
namespace Dcupon.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public JsonResult Register(string name, string email, string password,string source)
        {
            ...
            { 
            if (customerDetails.CheckDuplicates(model.Email, model.Password))
            {
                model.Password = Helper.Encrypt(model.Password, true);
                model.passwordVerificationToken = "";
                OntoDealsEntities db = new OntoDealsEntities();
                Customer obj = new Customer();
