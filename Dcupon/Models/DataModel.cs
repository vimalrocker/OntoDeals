...
namespace Dcupon.Models
{
    public class DataModel
    {
        ...
        public List<DataModel> listofstatics { get; set; }
        ...
        public List<DataModel> Loadstaticlist()
        {
            List<DataModel> list = new List<DataModel>();
            ...
            using (OntoDealsEntities db = new OntoDealsEntities())
            {
                try
                {
                    ...
                    list = (from websites in db.Websites
                            ...
                            where ((cupons.IsActive == 0 && websites.Isactive == 0 && categories.Isactive == 0) && (websites.Title.ToUpper().StartsWith(title.ToUpper()) || websites.Title.ToUpper().Contains(title.ToUpper()) || websites.Title.ToUpper().Equals(title.ToUpper())
                            || subcat.Title.ToUpper().StartsWith(title.ToUpper()) || subcat.Title.ToUpper().Contains(title.ToUpper()) 
                            || subcat.Title.ToUpper().Equals(title.ToUpper())))
