...
jQuery(document).ready(function () {
    ...
    $('.actions a.coupon-popover').click(function (e) {
        ...
        var setutl = url + 'Coupons?src=' + couponwebsite;
        var vendorurl = $(this).attr('data-url');
        ...
        if (couponType == '1') {
            ...
            $('.coupon-code').append('<span id="copy-t">copy code</span>');
    ...
    $('.cust_login').click(function () {
        if ($('#userReg #Name').val() != '' && $('#userReg #Email').val() != '' && $('#userReg #Password').val() != '' && $('#userReg #Password').val() != '') {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "text",
                url: "http://" + window.location.host + "/Customer/Register?name=" + $('#userReg #Name').val() + '&email=' + $('#userReg #Email').val() + '&password=' + $('#userReg #Password').val(),
                beforeSend: function () {
